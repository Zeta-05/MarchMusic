...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        try:
            ...
            await lols.edit_text("🍧ᴘ")        
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡᴇ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡᴇʀ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡᴇʀɪ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡᴇʀɪɴ**")
            await asyncio.sleep(0.1)
            await lols.edit_text("**🍧ᴘᴏᴡᴇʀɪɴɢ.**")
